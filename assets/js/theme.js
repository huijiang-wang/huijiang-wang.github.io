...
let setThemeSetting = (themeSetting, userInitiated = true) => {
  ...
  if (userInitiated) {
    localStorage.setItem(themeUserSetKey, "true");
  }
...
let determineThemeSetting = () => {
  ...
  const userInitiatedTheme = localStorage.getItem(themeUserSetKey) == "true";
  if (!userInitiatedTheme && (themeSetting == "dark" || themeSetting == "light")) {
    themeSetting = "system";
  }
